...
const Inputs = () => {
  ...
  return (
    <>
      <div className="flex flex-col gap-2 lg:gap-0 md:flex-row lg:flex-row  items-center justify-between space-x-2 my-2 mx-2">
        <div className="w-full">
          <p className="text-sm mb-1">Enter purchase price of Crypto</p>
          <input
            type="number"
            className="rounded-lg h-10 text-lg bg-gray-200 w-full"
            id="purchase"
        ...
        <div className="w-full">
          <p className="text-sm mb-1">Enter sale price of Crypto</p>
          <input
            type="number"
            className="rounded-lg h-10 text-lg bg-gray-200 w-full"
            id="sale"
      ...
      <div className="flex flex-col gap-2 lg:gap-0 md:flex-row lg:flex-row items-center justify-between space-x-2 my-2 mx-2">
        <div className="w-full">
          <p className="text-sm mb-1">Enter your Expenses</p>
          <input
            type="number"
            className="rounded-lg h-10 text-lg bg-gray-200 w-full"
            id="expense"
        ...
        <div className="w-full">
          <p className="text-sm mb-1">Investment Type</p>
          <Box className="flex flex-row space-x-2 ">
            <div className="w-full">
              <Box
                sx={term === "short" ? selected : notSelected}
                onClick={() => setTerm("short")}
                className="h-10 text-sm flex items-center justify-center px-2"
              >
                Short Term
                {term === "short" && (
      ...
      <div className="flex flex-col gap-2 lg:gap-0 md:flex-row lg:flex-row items-center justify-between space-x-2 my-2 mx-2">
        <div className="w-full">
          <p className="text-sm mb-1">Select your Annual Income</p>
          <Select
            sx={{ width: "100%" }}
            className="bg-white h-10 min-w-100 "
            value={income}
        ...
        <div className="w-full">
          ...
          {income === "min18" && (
            <p className="h-10 rounded-lg py-2 text-red-400">
      ...
      {term === "long" && (
        <div className="flex items-center justify-between space-x-2 my-2 mx-2">
          <div>
            <p className="text-sm mb-1">Capital Gains Amount</p>
            <Box
              sx={{
                width: "100%",
                borderRadius: "8px",
          ...
          <div>
            <p className="text-sm mb-1">Discount for Long Term Goals</p>
            <Box
              sx={{
                width: "100%",
                borderRadius: "8px",
      ...
      <div className="flex items-center justify-between space-x-2 my-2 mx-2">
        <div>
          <Box
            ...
            className="h-10 bg-green-200 text-lg text-center text-green-700 font-bold px-2 py-2 flex items-center gap-3"
          >
